...
//---------------------------------------------------------
void WP_FireRotaryCannonMissile(gentity_t* ent, vec3_t start, vec3_t dir, const qboolean alt_fire)
//---------------------------------------------------------
{
	int velocity = BLASTER_VELOCITY;
	int damage = alt_fire ? weaponData[WP_ROTARY_CANNON].altDamage : weaponData[WP_ROTARY_CANNON].damage;
	...
	missile->classname = "clone_proj";
	missile->s.weapon = WP_ROTARY_CANNON;
...
//---------------------------------------------------------
void WP_FireRotaryCannon(gentity_t* ent, const qboolean alt_fire)
//---------------------------------------------------------
{
	vec3_t dir, angs;
	...
	// FIXME: if temp_org does not have clear trace to inside the bbox, don't shoot!
	WP_FireRotaryCannonMissile(ent, muzzle, dir, alt_fire);
}